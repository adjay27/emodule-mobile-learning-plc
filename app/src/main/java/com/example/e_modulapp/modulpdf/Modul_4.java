...
public class Modul_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PDFView pdfView = (PDFView) findViewById(R.id.modul4pdf);
        pdfView.fromAsset("modul4.pdf").load();
        ...
        mHome_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Modul_4.this, HomeActivity.class);
        ...
        mNext_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_4.this, Modul_5.class);
                startActivity(intent);
            }
        });
        mPrev_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_4.this, Modul_3.class);
                startActivity(intent);
            }
        });
    }
