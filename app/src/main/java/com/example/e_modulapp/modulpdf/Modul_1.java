...
public class Modul_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PDFView pdfView = (PDFView) findViewById(R.id.modul1pdf);
        pdfView.fromAsset("modul1.pdf").load();
        ...
        mHome_fab.setOnClickListener(new View.OnClickListener() {
                                         ...
                                         public void onClick(View view) {
                                             Intent intent = new Intent(Modul_1.this, HomeActivity.class);
        ...
        mNext_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_1.this, Modul_2.class);
                startActivity(intent);
            }
        });
        mPrev_fab.setOnClickListener(view -> Toast.makeText(Modul_1.this,"Anda Telah Mencapai Batas Maksimal Halaman",Toast.LENGTH_SHORT).show());
