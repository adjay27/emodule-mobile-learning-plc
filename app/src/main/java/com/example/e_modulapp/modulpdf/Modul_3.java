...
public class Modul_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PDFView pdfView = (PDFView) findViewById(R.id.modul3pdf);
        pdfView.fromAsset("modul3.pdf").load();
        ...
        mHome_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Modul_3.this, HomeActivity.class);
        ...
        mNext_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_3.this, Modul_4.class);
                startActivity(intent);
            }
        });
        mPrev_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_3.this, Modul_2.class);
                startActivity(intent);
            }
        });
    }
