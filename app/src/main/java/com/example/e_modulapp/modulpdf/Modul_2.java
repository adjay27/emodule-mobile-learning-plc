...
public class Modul_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PDFView pdfView = (PDFView) findViewById(R.id.modul2pdf);
        pdfView.fromAsset("modul2.pdf").load();
        ...
        mHome_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Modul_2.this, HomeActivity.class);
        ...
        mNext_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_2.this, Modul_3.class);
                startActivity(intent);
            }
        });
        mPrev_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_2.this, Modul_1.class);
                startActivity(intent);
            }
        });
