...
public class Modul_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PDFView pdfView = (PDFView) findViewById(R.id.modul5pdf);
        pdfView.fromAsset("modul5.pdf").load();
        ...
        mHome_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Modul_5.this, HomeActivity.class);
        ...
        mNext_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_5.this, Modul_6.class);
                startActivity(intent);
            }
        });
        mPrev_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Modul_5.this, Modul_4.class);
                startActivity(intent);
            }
        });
    }
